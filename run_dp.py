...
from model.SDOR_UNet import DeblurNet
from train.trainer_dp import Trainer

parser = argparse.ArgumentParser(description='deblur arguments')
parser.add_argument("--batchsize",type = int, default = 23)
...
parser.add_argument("--loadchdir",type=str,default='./checkpoint/MSSNet/model_01291'
                                                   'E.pt')
